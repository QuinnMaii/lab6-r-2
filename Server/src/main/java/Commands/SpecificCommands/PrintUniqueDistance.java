...
public class PrintUniqueDistance extends AbstractCommand implements Serializable {
    ...
    public void execute(Object o, DatagramSocket datagramSocket, DatagramPacket datagramPacket) throws IOException {
        ...
        Logging.log(Level.INFO, "Server is executing printUniqueDistance command....");
        receiver.minByOfficialAddress((String) o);
    }
}